...
export default function AnimatedButtonDynamic({ title }: Types) {
  return (
    <button className="relative flex items-center justify-center rounded-full dynamic-button group border-1 border-[#6E6F7A] w-full text-black md:w-[120px] h-[40px] font-semibold overflow-hidden transition-all duration-300">
      {/* Background layer */}
